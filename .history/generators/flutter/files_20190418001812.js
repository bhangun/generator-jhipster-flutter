...
function writeFiles() {
    return {
        ...
        writeClientResourceFiles() {
            ...
            this.template(`${flutterDir}ios/Runner.xcodeproj/project.pbxproj`, `${this.packageFolder}/ios/Runner/Runner.xcodeproj/project.pbxproj`);
            this.template(`${flutterDir}ios/Runner.xcodeproj/project.xcworkspace/contents.xcworkspacedata`, `${this.packageFolder}/ios/Runner/Runner.xcodeproj/project.xcworkspace/contents.xcworkspacedata`);
            this.template(`${flutterDir}ios/Runner.xcodeproj/xcshareddata/xcschemes/Runner.xcscheme`, `${this.packageFolder}/ios/Runner/Runner.xcodeproj/xcshareddata/xcschemes/Runner.xcscheme`);
